...
/** The original single-file weekly flow, unchanged — moved out of app/page.tsx verbatim
 * so it can sit alongside the new Monthly Report flow behind a mode switch. */
